...
**v4.2.1** Expose energy injection interface; add density jump interface. Add synchrotron radiation characteristic frequency readout. Modify the compilation flow and remove the limitation on the Python version.  
